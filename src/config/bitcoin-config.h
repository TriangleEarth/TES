...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The TriangleEarthSociety Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "TriangleEarthSociety Core"
...
#define PACKAGE_BUGREPORT "https://github.com/TriangleEarthSociety-project/TriangleEarthSociety/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "TriangleEarthSociety Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TriangleEarthSociety Core 0.15.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "TriangleEarthSociety"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://hppy.be/"
